  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        <section
          id="about"
          className="py-20 md:py-32 bg-tech-pattern gradient-bg"
        >
          <div className="container">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-muted-foreground mb-8">
                Backend Developer | Node.js, Express, Django, FastAPI |
                PostgreSQL & MongoDB | AWS | Scalable APIs with Python &
                JavaScript
              </p>
        ...
        <section id="projects" className="py-20 bg-tech-pattern gradient-bg">
          <div className="container">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              />
              <ProjectCard
                title="Automated AI Jobs Checker"
                description="This repository contains a FastAPI application designed to check job postings from given URLs and determine their suitability for specific profiles using various AI models"
                technologies={["Python", "FastAPI", "Railway", "React"]}
                githubUrl="https://github.com/Tonyjr7/JobsChecker"
              />
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-border/40 py-6">
        <div className="container flex flex-col items-center justify-center gap-4 md:flex-row md:justify-between">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Anthony Triumph. All rights reserved.
          </p>
